...
A plugin layer for the Claude Code VS Code extension. Prototype injects a small loader into the
...
Named for the dog who quietly fixes Wallace's contraptions from the inside while Wallace remains
oblivious.
...
## Layout
    ...
    packages/core         @prototype/core: harvest, codegen, inject, plugin discovery, update flow
    packages/cli          prototype: the command-line surface over core
    packages/host         the injected loader, pre.js and post.js
    packages/plugin-api   @prototype/plugin-api: what a plugin is written against
